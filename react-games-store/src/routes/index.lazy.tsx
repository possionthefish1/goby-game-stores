					...
					<div className='grid grid-cols-2 gap-8 w-full auto-rows-fr'>
						...
						<div className='prose col-span-1 text-3xl'>
							...
							<p className='text-base text-pretty'>
								...
								adipisicing elit. Nihil mollitia facilis dolore
								ullam et dolorem in harum ipsam? Eveniet facilis
								amet id delectus fugiat.
							</p>
							...
							<div className='bg-neutral rounded-b-lg p-4'>
								<div className='flex gap-4 flex-col'>
									...
									<div className='flex items-center gap-2'>
										<div className='div'>
											<div className='avatar-group -space-x-6 rtl:space-x-reverse  *:hover:cursor-pointer'>
